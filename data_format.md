...
This document describes the **input and output format** of all tasks in the Petri Net assignment project.

------------------------------------------------------------

Task 1 – PNML Parser
Input: 
`data/example.pnml` – a Petri Net model in PNML (XML) format.
Output: 
